...
public class confirmCustomerActivity extends Activity {
                ...
                fAuth.createUserWithEmailAndPassword(emailtxt,psw).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(confirmCustomerActivity.this, "User Created.", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(confirmCustomerActivity.this, "Error ! " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            progressBar.setVisibility(View.GONE);
                        }
                    }
                });
